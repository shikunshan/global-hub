...
| 序号 | 分类 ID | 名称 | 定位 | 网站数量 |
|------|---------|------|------|----------|
| 1 | ai-frontier | AI 前沿 | 核心精选板块，聚焦人工智能最前沿 | 13 |
| 2 | tech-dev | 技术与开发 | 程序员与开发者必备工具与社区 | 14 |
| 3 | knowledge-learning | 知识与学习 | 全球优质教育与知识资源 | 10 |
| 4 | design-assets | 设计素材 | 无版权素材、配色、灵感资源 | 9 |
| 5 | media-news | 媒体与新闻 | 全球权威新闻与商业媒体 | 10 |
| 6 | tools-productivity | 工具与效率 | 提升效率的在线工具与服务 | 14 |
| 7 | life-services | 生活服务 | 出行、健康、生活实用工具 | 7 |
| 8 | music-audio | 影音音乐 | 纯净音乐、白噪音、电台 | 7 |
| 9 | info-exploration | 信息探索 | 趣味数据可视化与探索网站 | 8 |
| 10 | china-access | 中文精选 | 中文互联网优质站点 | 11 |

**总计：103 个精选网站，覆盖 10 大分类**

### 数据来源与质量标准

- 网站均经过人工筛选，确保内容质量高、无恶意广告、品牌可信
- 参考 extensive-website.md 中的优质站点清单补充扩展
- 优先收录非营利、开源、官方机构、行业公认的权威站点
- 每个网站均提供中英双语简介，便于国际化使用
- Logo 必须使用各网站真实 favicon，禁止 emoji 或虚构图标
